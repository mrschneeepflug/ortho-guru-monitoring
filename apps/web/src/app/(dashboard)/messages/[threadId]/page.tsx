  ...
  return (
    <div className="flex flex-col h-[calc(100vh-10rem)]">
      ...
      <div className="flex-1 overflow-y-auto space-y-4 mb-4">
        {messages.map((msg) => (
          <div key={msg.id} className={cn('max-w-[70%] p-3 rounded-lg', msg.senderId === user?.id ? 'ml-auto bg-medical-blue text-white' : 'bg-white shadow-sm')}>
      ...
      <form onSubmit={handleSend} className="flex gap-3">
        ...
        <button
          ...
          className="px-6 py-2 bg-medical-blue text-white rounded-lg hover:bg-medical-dark transition-colors disabled:opacity-50"
        >
          Send
        </button>
      </form>
